...
$sql="SELECT memberID,namelast,namefirst,address,city,state,zip,phone,email FROM members WHERE active_rso=1 ORDER BY namelast,namefirst";
...
$body.="<tr><td colspan=\"8\" style=\"text-align: left\">Active Range Safety Officers List -- ".count($data)." members</b></td></tr>";
$background=NULL;
$count=1;
foreach($data as $row) {
	$body.="<tr>\n";
