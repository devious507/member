...
$sql="SELECT memberID,namelast,namefirst,address,city,state,zip,phone,email FROM members WHERE rso=1 OR active_rso=1 ORDER BY namelast,namefirst";
...
$body.="<tr><td colspan=\"8\" style=\"text-align: left\">Range Safety Officer List -- ".count($data)." members</b></td></tr>";
$background=NULL;
$count=1;
foreach($data as $row) {
	$body.="<tr>\n";
